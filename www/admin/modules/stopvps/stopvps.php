...
// SQL query to change
$query = "UPDATE `fosvm`.`Servers` SET `action` = 'stop' WHERE `vpsid` = '".$cid."';";
$result = mysql_query($query) or die("Couldn't execute query");


  echo "The VPS $vpsid is being stopped.<br/>";
  echo "**Note**";
  echo "It may take upto 1 minute for the VPS to be stopped";
