...
`action`) VALUES ('".@$_POST['user']."', '".@$_POST['vid']."', '".@$_POST['ip1']."', '".@$_POST['ip2']."', '".@$_POST['dns1']."', '".@$_POST['dns2']."', 
'".@$_POST['dram']."', '".@$_POST['bram']."', '".@$_POST['disk']."', '".@$_POST['host']."', '".@$_POST['pswd']."', '".@$_POST['os']."', 'yes', 'rebuild');";
