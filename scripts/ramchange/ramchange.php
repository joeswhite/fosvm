...
$query = "SELECT *  FROM `Servers` WHERE `update` = 'upram'";
...
$row= mysql_fetch_array($result);
  ...
  shell_exec('/fosvm/scripts/ramchange/ramchange.sh '.$cid.' '.$dram.' '.$bram.'');
// SQL query to change 
$query2 = "UPDATE `Servers` SET `update` = 'no' WHERE `vpsid` = '".$cid."' LIMIT 1 ;";
